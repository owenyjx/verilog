...
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { r[0] }]; #IO_L7P_T1_D09_14 Sch=r[4]
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { r[1] }]; #IO_L18N_T2_A11_D27_14 Sch=r[5]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { r[2] }]; #IO_L17P_T2_A14_D30_14 Sch=r[6]
