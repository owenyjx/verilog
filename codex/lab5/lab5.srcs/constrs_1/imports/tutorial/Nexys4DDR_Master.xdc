...
#set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports { inc }]; #IO_L7N_T1_D10_14 Sch=sw[5]
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { dec }]; #IO_L17N_T2_A13_D29_14 Sch=sw[6]
...
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { step }]; #IO_L15P_T2_DQS_RDWR_B_14 Sch=sw[10]
