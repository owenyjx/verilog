...
set_property -dict { PACKAGE_PIN V14   IOSTANDARD LVCMOS33 } [get_ports { f[0] }]; #IO_L22N_T3_A04_D20_14 Sch=f[13]
set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { f[1] }]; #IO_L20N_T3_A07_D23_14 Sch=f[14]
